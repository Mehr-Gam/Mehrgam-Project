...
export const createServiceRequestSchema = z.object({
  body: z
    .object({
      ...
      // Frontend selects this on the map. Address can be sent by frontend or resolved by backend with Neshan.
      originAddress: optionalTextSchema,
      originLat: latitudeSchema,
      originLng: longitudeSchema,

      // Destination is optional in MVP, but when the frontend has a finish point it must send both lat/lng.
